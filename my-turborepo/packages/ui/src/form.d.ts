...
declare const useForm: <TOut, TDef extends ZodTypeDef, TIn extends FieldValues>(
  props: Omit<UseFormProps<TIn>, "resolver"> & {
    schema: ZodType<TOut, TDef, TIn>;
  },
) => import("react-hook-form").UseFormReturn<TIn, any, undefined>;
declare const Form: <
...
declare const FormControl: React.ForwardRefExoticComponent<
  Omit<
    import("@radix-ui/react-slot").SlotProps & React.RefAttributes<HTMLElement>,
    "ref"
  > &
