...
function TimelineDay({ dayNumber, dayName, events }: { dayNumber: number; dayName: string; events: Event[] }) {
    const highlightIndex = events.findIndex(e => e.title === "Hacking Begins");

    return (
        <div className="w-full bg-[#F5EDE4] shadow-lg overflow-hidden">
            {/* header */}
...
export default function SchedulePage() {
    ...
    return (
        <main className="min-h-screen bg-[#3A3A3A] p-4 md:p-8">
