  ...
  return (
    <div className="h-full w-full items-center justify-center bg-blue-200 p-4">
      <div className="rounded-lg border-4 bg-white/90 p-4">
        ...
        <Prizes
          prizes={[
            { name: "TV", img_url: "/prizes/TV.png" },
            { name: "Beats Heaphones", img_url: "/prizes/Beats.png" },
          ]}
        />
        <div className="flex items-center justify-center pt-6">
          <a
            ...
            href="https://cdn.discordapp.com/attachments/1304883198450204754/1304883510657421432/Challenge_Info-20241109T185800Z-001.zip?ex=673102f8&is=672fb178&hm=24f1cfc382636bd3820c55fbdb527f17cb1f668ead032cb7505b220e43390896&"
            target="_blank"
          >
            Get Data
          </a>
