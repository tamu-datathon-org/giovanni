                    ...
                    >
                        ...
                        >
                            ...
                            <svg width="432" height="94" viewBox="0 0 447 94" fill="none"
                                ...
                                <text x="3%" y="25" font-size="18" fill="#9A5C24" dy="38" dx="20">{faq.question}</text>
                            </svg>
                        ...
                        >
                            <div className="text-center p-4 bg-dalgonabase border-t-4 border-dalgonatext text-dalgonatext">
                                {faq.answer}
                            </div>
                        </div>
                    </div>
