...
const Hero = () => {
  return (
    <div className="relative grid grid-cols-10 [grid-template-rows:repeat(10,)] md:[grid-template-rows:repeat(14,80px)] min-h-screen sm:min-h-fit w-full overflow-hidden pb-8">
        {/* Desk background */}
        ...
        <div className="relative z-10 col-start-1 col-span-10 row-start-2 md:row-start-2 row-span-8 flex items-top justify-center ">
            <NewspaperSection />
        </div>

        {/* cup - bottom left */}
        <div className="relative z-20 col-start-1 md:col-start-2 col-span-3 row-start-6 md:row-start-9 row-span-3 w-full aspect-square max-w-[325px]">
            <Image
