          ...
          <div className="w-full p-4 text-center lg:w-1/2">
            <div className="max-w-[700px]">
              <div className="mb-9">
                ...
                <p className="text-body-color text-body-color-dark text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed">
                ...
                <p className="text-body-color-dark pt-6 text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed">
