        ...
        <div className="-mx-4 flex flex-wrap items-center">
          ...
          <div className="w-full p-4 text-center lg:w-1/2">
            <div className="max-w-[700px]">
              <div className="mb-9">
                <h3 className="mb-4 text-xl font-bold text-datablue sm:text-2xl lg:text-xl xl:text-2xl">
                  Innovate Through Challenge
                </h3>
                <p className="text-body-color text-white text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed">
                ...
                <p className="text-body-color text-white pt-6 text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed">
