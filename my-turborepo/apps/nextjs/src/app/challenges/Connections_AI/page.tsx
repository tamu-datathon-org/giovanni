  ...
  return (
    <div className="h-full w-full justify-center bg-blue-200 p-4">
      <div className="rounded-lg border-4 bg-white/90 p-4">
        ...
        <Title>Connections AI</Title>
        <Heading>Background</Heading>
        <Paragraph>
          The Connections game from The New York Times (NYT) has become a
          popular brain teaser, challenging players to associate words based on
          categories. With advancements in artificial intelligence (AI), the
          question arises: can we teach AI to recognize categorical patterns?
          The objective is to develop a bot capable of effectively categorizing
          a set of words into four distinct groups based on their connections.
        </Paragraph>
        ...
        <Paragraph>
          ...
          to the best of your abilities. You will be given the board of 16 words
          arranged randomly, and you will have to select the best 4 words
          possible that match a group for four distinct groups in order to
          ensure your success. We will provide you with the API for the game and
          some starter code. We encourage you to be creative with different
          models and possible logic, exploring new ways of “solving” the game.
        </Paragraph>
        ...
        <Paragraph>
          The words will be represented by a 16 element 1D array. Each word will
          be arranged in a random order. The words should be grouped together
          and outputted as a 4x4 2D array.
        </Paragraph>
        <Heading>Implementation Algorithms</Heading>
        Common ways to use algorithms to solve games are as follows:
        <br /> <br />
        <b>Natural Language Processors (NLP) Libraries</b> - strong approach for
        understanding linguistics. Entirely heuristic approaches are weaker than
        the methods below, but perform far better than picking random moves. As
        some form of heuristics will be used in most of the below approaches,
        they are still important to understand.
        <Bullet
          items={[
        ...
        />
        <br />
        <b>Data Sources </b> - training your model on real world data. There are
        many datasets out there to give contextual meaning to tokens and words
        for the model to analyze. Transforming the data is often necessary to
        help the model perform analysis.
        <Bullet
          items={[
        ...
        />
        <br />
        <b>Machine Learning Frameworks </b> - tools to build and fine-tune your
        model. Many pretrained models are available with these frameworks that
        could give an advantage to a ground up model.
        <Bullet
          items={[
        ...
        <b>Additional Resources </b> - helpful resources to transform data and
        tune your model.
        <Bullet
          items={[
        ...
        connections.zip. We will provide starter code for how to run the game
        and inputs. Your model will use a Flask application to send and receive
        words from the server. It will receive words from the POST request, and
        the model will output its 4 word guess of a group. The model will take
        in words, strikes, isOneAway, correctGroups, previousguesses, and error.
        <br />
        <br />
        <b>Webhooks</b>
        <pre>
        ...
        <Paragraph>
          There will be an api provided at this endpoint: /. By sending a POST
          request to the endpoint, it will receive the status of the game and
          use your model then evaluate the guess. This is a test game, and the
          model will be using random example words.
          <br />
          Example: Setup your model to use the inputs and output a 4 word 1D
          array and endTurn boolean to the POST request.
        </Paragraph>
        <Heading>Grading</Heading>
        After submitting, your models will be evaluated on a testing dataset.
        Each guess is weighted differently depending on the number of correct
        guesses. There are no groups worth more than others based on difficulty.
        Instead, the group with the least successful guess will have the highest
        multiplier. This encourages to guess with confidence and accurately on
        the first attempt.
        <br />
        Example:
        <Bullet
        ...
        />
        For each guess, points will only be awarded 1 point if the model gets
        4/4 correct. They will not be awarded any partial points.
        <br /> <br />
        Each “guess” is defined as a submission of a group of 4 words. If the
        model does not get 4/4 correct in the group, then the guess counts as
        incorrect. We will be tallying the points and multipliers at the end of
        their guesses, not after every guess. Once the model reaches 4 strikes,
        their turn ends and we can tally the points.
        <br /> <br />
        The model will also have an option to stop guessing. This option will
        end their current turn, tally the points and finally move on to the next
        test set.
        <br />
        <br />
        Example Scenarios:
        ...
        <div className="flex items-center justify-center pt-6">
          <a
            ...
            href="https://cdn.discordapp.com/attachments/1210713468714352701/1304912310598504561/Connections_AI.zip?ex=67311dca&is=672fcc4a&hm=185ac3e85b9c3357f46f7bd6cefdb863dda254eee47e8021b3f8a10a5eb5f94c&"
            target="_blank"
          >
            Get Data
          </a>
        ...
        <Prizes
          prizes={[
            {
              name: "GoTrax GXL V2 Lightweight Scooter",
              img_url: "/prizes/escooter.jpg",
            },
            { name: "Keychron V1 Keyboard", img_url: "/prizes/keyboard.jpg" },
            {
              name: "6 Quart Gourmia Air Fryer",
              img_url: "/prizes/air_fryer.jpg",
            },
          ]}
        />
      </div>
