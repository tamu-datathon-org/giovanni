...
import GenericDropdown from "~/app/_components/genericDropdown";
    ...
    <div className="flex w-full justify-center lg:w-3/5 ">
      <Form {...form}>
        <form
          ...
          className="overflow-x-hidden rounded-lg bg-white p-5 lg:px-16"
        >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="More resources." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
