...
function Lines() {
    return <div className="w-full pr-3"> {/**Random Lines */}
...
function ExitButton() {
    ...
    return <Button className="compStyling"><AiOutlineClose className="close" /></Button>;
}

function TitleText() {
    return <h1 className="md:text-6xl text-5xl p-10 pb-5">
        ...
        <div className="font-XPfont font-bold">
            <div className="flex flex-col h-screen items-center justify-center ">
                <form onSubmit={handleSubmit(onSubmit)}
                    className="flex flex-col items-center text-center lg:w-2/5 w-11/12 text-lg xpBorder m-5">
                    <div className="flex flex-row w-full items-center justify-center">
                        <Lines />
                        <ExitButton />
                    </div>
                    <div
                        className="flex flex-col relative items-center overflow-hidden bg-[#e4e3e4] w-full mt-3 border-[#585958] lg:border-[1px] border-0">
                        <TitleText />
                        ...
                        >
                            {
                                isSubmitting ?
                                    <Image src="loading.svg" className="animate-spin" width={24} height={24}
                                        aria-hidden="true" alt="loading..." />
                                    : "Submit"
                            }
                        </Button>
                        <Image src="/Pixel_PolarBear.png"
                            className="absolute -bottom-5 -right-5 xl:size-44 lg:size-28 md:size-56 size-32"
                            width={100} height={100} alt="polar bear" />
