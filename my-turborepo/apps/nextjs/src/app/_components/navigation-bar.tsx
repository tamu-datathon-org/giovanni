...
import { cn } from "@vanni/ui/index"
//import { Icons } from "@vanni/ui/icons"
import {
    NavigationMenu,
...
export function NavigationBar() {
    return (
        <NavigationMenu className="">
            <NavigationMenuList className="flex justify-center w-screen bg-background p-5" >
