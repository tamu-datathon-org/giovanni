...
export default function LoginPage(props: {
  ...
  return (
      <main
          className="flex font-XPfont bg-large-device h-screen w-screen items-center justify-center bg-cover bg-center bg-no-repeat">
          <div className="flex max-w-full flex-col xpBorder items-center justify-center">
                  <div className="p-3 flex w-fit flex-col items-center text-center text-lg">
                      ...
                      <div
                          className="relative mt-2 flex w-full flex-col items-center justify-center border border-black bg-[#e4e3e4] p-8 px-16">
