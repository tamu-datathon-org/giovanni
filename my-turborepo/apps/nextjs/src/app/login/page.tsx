      ...
      <main
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="xpBorder p-3 flex w-fit flex-col items-center text-center text-lg">
              ...
              <div
                  className="relative mt-3 px-14 py-8 flex w-full flex-col items-center overflow-hidden border-0 border-[#585958] bg-[#e4e3e4] lg:border-[1px]">
                  ...
                  <div className="w-full text-[#9c9c9c]">
                      ...
                      <text className="absolute left-0">Post version 202.4</text>
                  </div>
